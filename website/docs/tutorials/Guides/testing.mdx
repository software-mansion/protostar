# Testing
Protostar provides users a flexible testing environment for cairo smart contracts. 
It allows to write unit and integration tests and modify the blockchain state with cheatcodes.
...
Then in `tests` directory create file `test_utils.cairo`, this contract with two test cases.
```
...
func test_proxy_contract{syscall_ptr : felt*, range_check_ptr}():
    ...
    # Calls increase_balance through proxy contract
