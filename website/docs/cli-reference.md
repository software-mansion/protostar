...
#### `--profiling`
Run profiling for a test contract. Works only for a single test case. Protostar generates a file that can be opened with [pprof](https://github.com/google/pprof).
