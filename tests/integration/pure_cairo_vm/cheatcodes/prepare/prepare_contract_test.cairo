...
func test_preparing_deployment_no_constructor(){
    ...
    %{
        declared = declare("./src/basic_no_constructor.cairo")
...
func test_preparing_deployment_with_constructor_no_args(){
    ...
    %{
        declared = declare("./src/basic_with_constructor_no_args.cairo")
        prepared = prepare(declared)
...
func test_preparing_deployment_with_constructor_data_transformer(){
    ...
    %{
        declared = declare("./src/basic_with_constructor.cairo")
        prepared = prepare(declared, {"initial_balance": ids.initial_balance_input})
...
func test_preparing_deployment_with_constructor_no_data_transformer(){
    ...
    %{
        declared = declare("./src/basic_with_constructor.cairo")
        prepared = prepare(declared, [ids.initial_balance_input])
        ids.initial_balance = prepared.constructor_calldata[0]
