...
def test_deploy_cairo0(datadir: Path):
    ...
    return_values = {
        "test_deploy_cairo0": {"deployed_contract_address": 123},
        "test_deploy_cairo0_no_args": {"deployed_contract_address": 4443},
        "test_deploy_tp_cairo0": {"deployed_contract_address": 0},
    }
