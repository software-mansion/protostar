...
async def test_load_cheatcode(mocker):
    ...
    assert_cairo_test_cases(
        ...
        expected_passed_test_cases_names=[
            "test_load_in_deployed_contract",
            "test_load_map_in_deployed_contract",
            "test_load_map_complex_key_in_deployed_contract",
            "test_load_map_struct_key_in_deployed_contract",
