...
@external
func test_store_in_deployed_contract{
...
@external
func test_store_map_in_deployed_contract{
    syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr
}() {
    alloc_locals;
    local contract_address;
...
@external
func test_store_map_complex_key_in_deployed_contract{
    syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr
}() {
    alloc_locals;
    local contract_address;
...
@external
func test_store_map_struct_key_in_deployed_contract{
    syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr
}() {
    alloc_locals;
    local contract_address;
...
@external
func test_store_map_struct_val_in_deployed_contract{
    syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr
}() {
    alloc_locals;
    local contract_address;
