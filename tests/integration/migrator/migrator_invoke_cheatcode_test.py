...
invoke(contract_address, "increase_balance", {"amount": 42}, {"max_fee": "auto"})
...
invoke(contract_address, "increase_balance", {"amount": 20}, {"max_fee": "auto"})

invoke(contract_address, "increase_balance", {"amount": 22}, {"max_fee": "auto"})
